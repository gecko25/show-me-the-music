// We adapted this from @types/spotify-web-playback-sdk
// https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/spotify-web-playback-sdk/index.
// The original type definitin wasnt exported as a module
...
declare namespace Spotify {
  ...
  interface PlaybackState {
    ...
    // Added types
    playback_features: {
      hifi_status: string; // "NONE"
      change_playback_speed: boolean;
    };
    playback_quality: string; // "VERY_HIGH"
    playback_speed: number; // 1
    timestamp: 1637337211384;
  }
